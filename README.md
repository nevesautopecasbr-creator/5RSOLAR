...
- API (`apps/api`): revisar estratégia de hospedagem por conta de jobs BullMQ.
- Plano detalhado: `docs/roadmap-supabase-vercel.md`.
- Checklist técnico: `docs/deploy-checklist.md`.
- Matriz de variáveis: `docs/environment-matrix.md`.
