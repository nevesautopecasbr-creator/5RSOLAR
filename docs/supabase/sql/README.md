...
4. Repita para `02-refresh-tokens.sql`, depois `03-project-budget.sql`, e assim por diante até `18-module03-document-management.sql`. **Antes da 18:** crie o bucket **project-documents** em Storage no dashboard.
