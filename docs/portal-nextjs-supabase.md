...
5. Na raiz: `pnpm dev:portal` (ou dentro de `apps/portal`: `pnpm dev`).
...
4. Quando tudo estiver migrado, desativar ou remover `apps/api` e `apps/web` e usar só o portal na Vercel.
